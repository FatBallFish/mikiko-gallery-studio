...
At minimum set database credentials, `DATABASE_URL`, SMTP settings, `AUTH_ACCESS_TOKEN_SECRET`, `API_KEY_SIGNING_SECRET_ENCRYPTION_KEY`, `PIC_GALLERY_ADMIN_PASSWORD`, and `PIC_GALLERY_ADMIN_TOKEN_SECRET`.
