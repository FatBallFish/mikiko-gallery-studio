import type {
  ...
  AdminVideoCapabilityWrite,
  AdminVideoQuoteSimulationRequest,
  AdminVideoQuoteSimulationResult,
  AdminVideoRateCard,
  AdminVideoRateCardWrite,
  AdminVideoCostRuleWrite,
  AdminVideoPriceRuleWrite,
  AdminVideoRouteConfigWrite,
  AdminVideoSimulationRequest,
  AdminVideoSimulationResult,
  AdminVideoStrategyWrite,
  AdminVideoRecovery,
  AdminVideoTaskDetail,
  AdminVideoTaskPage,
  AdminUser,
...
export const adminApi = {
  ...
  listVideoRateCards: async (id: string | number) => (await sharedApiClient.request<{items: AdminVideoRateCard[]}>(API_PATHS.ops.videoModelRateCards, { pathParams: { id } })).items ?? [],
  saveVideoRateCard: (id: string | number, input: AdminVideoRateCardWrite) => sharedApiClient.request<AdminVideoRateCard>(API_PATHS.ops.videoModelRateCards, { method: 'POST', pathParams: { id }, body: input }),
  deleteVideoRateCard: (id: string | number, rate_card_id: string | number, expected_version: number) => sharedApiClient.request<void>(API_PATHS.ops.videoModelRateCardDetail, { method: 'DELETE', pathParams: { id, rate_card_id }, query: { expected_version } }),
  simulateVideoRouteQuote: (id: string | number, input: AdminVideoQuoteSimulationRequest) => sharedApiClient.request<AdminVideoQuoteSimulationResult>(API_PATHS.ops.videoRouteQuoteSimulation, { method: 'POST', pathParams: { id }, body: input }),
  listVideoCostRules: (id: string | number) => sharedApiClient.request<{items: AdminVideoConfiguration['cost_rules']}>(API_PATHS.ops.videoModelCostRules, { pathParams: { id } }),
  saveVideoCostRule: (id: string | number, input: AdminVideoCostRuleWrite) => sharedApiClient.request<AdminVideoConfiguration['cost_rules'][number]>(API_PATHS.ops.videoModelCostRules, { method: 'POST', pathParams: { id }, body: input }),
  deleteVideoCostRule: (id: string | number, rule_id: string | number, expected_version: number) => sharedApiClient.request<void>(API_PATHS.ops.videoModelCostRuleDetail, { method: 'DELETE', pathParams: { id, rule_id }, query: { expected_version } }),
  listVideoPricingStrategies: () => sharedApiClient.request<{items: AdminVideoConfiguration['pricing_strategies']; price_rules: AdminVideoConfiguration['price_rules']}>(API_PATHS.ops.videoPricingStrategies),
  createVideoPricingStrategy: (input: AdminVideoStrategyWrite) => sharedApiClient.request<AdminVideoConfiguration['pricing_strategies'][number]>(API_PATHS.ops.videoPricingStrategies, { method: 'POST', body: input }),
  updateVideoPricingStrategy: (id: string | number, input: AdminVideoStrategyWrite) => sharedApiClient.request<AdminVideoConfiguration['pricing_strategies'][number]>(API_PATHS.ops.videoPricingStrategyDetail, { method: 'PUT', pathParams: { id }, body: input }),
  deleteVideoPricingStrategy: (id: string | number, expected_version: number) => sharedApiClient.request<void>(API_PATHS.ops.videoPricingStrategyDetail, { method: 'DELETE', pathParams: { id }, query: { expected_version } }),
  simulateVideoPricing: (id: string | number, input: AdminVideoSimulationRequest) => sharedApiClient.request<AdminVideoSimulationResult>(API_PATHS.ops.videoPricingStrategySimulate, { method: 'POST', pathParams: { id }, body: input }),
  recalculateVideoPricing: (id: string | number, input: {route_model_id: number; combinations: AdminVideoSimulationRequest[]; effective_at: string}) => sharedApiClient.request<{items: AdminVideoConfiguration['price_rules']}>(API_PATHS.ops.videoPricingStrategyRecalculate, { method: 'POST', pathParams: { id }, body: input }),
  createVideoPriceRule: (input: AdminVideoPriceRuleWrite) => sharedApiClient.request<AdminVideoConfiguration['price_rules'][number]>(API_PATHS.ops.videoPriceRules, { method: 'POST', body: input }),
  updateVideoPriceRule: (id: string | number, input: AdminVideoPriceRuleWrite) => sharedApiClient.request<AdminVideoConfiguration['price_rules'][number]>(API_PATHS.ops.videoPriceRuleDetail, { method: 'PUT', pathParams: { id }, body: input }),
  deleteVideoPriceRule: (id: string | number, expected_version: number) => sharedApiClient.request<void>(API_PATHS.ops.videoPriceRuleDetail, { method: 'DELETE', pathParams: { id }, query: { expected_version } }),
  getRouteVideoConfig: (id: string | number) => sharedApiClient.request<AdminVideoConfiguration['routes'][number]>(API_PATHS.ops.routeVideoConfig, { pathParams: { id } }),
