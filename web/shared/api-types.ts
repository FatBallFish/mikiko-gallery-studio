...
export type AdminVideoImpact = { route_model_id?: number; code: string; summary: string; blocking: boolean; fix_route: 'models' | 'routing' | string }
...
export type AdminVideoQuoteCandidate = {
	route_candidate_id: number; account_model_id: number; provider_code: string; model_code: string
	capability_version: string; pricing_schema: string; rate_version: number; eligible: boolean
