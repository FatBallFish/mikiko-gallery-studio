...
export const demoCapability: Capability = {
  model_groups: [
    ...
    { id: 'plus', code: 'plus', name: 'Plus', description: 'Balanced route with image editing support', task_types: ['text_to_image', 'image_edit'], qualities: ['auto', '1K', '2K'], effective_multiplier: '0.90000', prices: [{ task_type: 'text_to_image', quality: 'auto', base_points: '5.12500', charged_points: '4.61250', display_points: '4.61' }], supports_reference: true, max_reference_image_count: 3 },
    { id: 'pro', code: 'pro', name: 'Pro Studio', description: 'High quality grouped route', task_types: ['text_to_image', 'image_edit'], qualities: ['auto', '2K', '4K'], effective_multiplier: '0.80000', prices: [{ task_type: 'text_to_image', quality: '2K', base_points: '8.00000', charged_points: '6.40000', display_points: '6.40' }], supports_reference: true, max_reference_image_count: 3 },
  ],
...
export const endpointDocs: EndpointDoc[] = [
  ...
  { group: 'Agent API', method: 'GET', path: API_PATHS.agent.estimate, title: '价格预估', auth: 'Access Token', requestExample: '{"task_type":"image_edit","route_model_code":"plus"}', responseExample: '{"charged_points":"15.37500","display_points":"15.38","resolved_quality":"2K"}' },
