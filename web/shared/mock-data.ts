...
export const demoProfile: UserProfile = {
  ...
  preferences: { model_group: 'plus-image', base_resolution: 'auto', aspect_ratio: '1:1', image_count: 2, theme_mode: 'dark', accent_theme: 'amber' },
}

export const demoCapability: Capability = {
  model_groups: [
    { id: 'basic', code: 'basic', name: 'Basic', description: 'Fast public route', task_types: ['text_to_image'], base_resolution: ['auto', '1K'], size_modes: ['ratio'], aspect_ratios: ['1:1', '16:9'], pixel_sizes: [], effective_multiplier: '1.00000', prices: [{ task_type: 'text_to_image', base_resolution: '1K', base_points: '2.00000', charged_points: '2.00000', display_points: '2.00' }], supports_reference: false, max_reference_image_count: 0 },
    { id: 'plus', code: 'plus', name: 'Plus', description: 'Balanced route with reference support', task_types: ['text_to_image', 'reference_to_image', 'image_edit'], base_resolution: ['auto', '1K', '2K'], size_modes: ['ratio', 'pixel'], aspect_ratios: ['1:1', '16:9', '9:16', '4:3'], pixel_sizes: ['1024x1024', '2048x1024'], effective_multiplier: '0.90000', prices: [{ task_type: 'text_to_image', base_resolution: 'auto', base_points: '5.12500', charged_points: '4.61250', display_points: '4.61' }], supports_reference: true, max_reference_image_count: 3 },
    { id: 'pro', code: 'pro', name: 'Pro Studio', description: 'High quality grouped route', task_types: ['text_to_image', 'reference_to_image', 'image_edit'], base_resolution: ['auto', '2K', '4K'], size_modes: ['ratio', 'pixel'], aspect_ratios: ['1:1', '16:9', '9:16', '4:3', '3:4'], pixel_sizes: ['2048x2048', '4096x4096'], effective_multiplier: '0.80000', prices: [{ task_type: 'text_to_image', base_resolution: '2K', base_points: '8.00000', charged_points: '6.40000', display_points: '6.40' }], supports_reference: true, max_reference_image_count: 3 },
  ],
  base_resolution: ['auto', '1K', '2K', '4K'],
  aspect_ratios: ['1:1', '16:9', '9:16', '4:3', '3:4'],
  pixel_sizes: ['1024x1024', '2048x1024', '2048x2048', '4096x4096'],
  max_image_count: 4,
