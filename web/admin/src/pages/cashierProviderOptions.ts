...
const providerConfigFields: Record<string, CashierProviderConfigField[]> = {
  ...
  alipay_direct: [
    ...
    { key: 'app_id', label: '应用 ID', hint: '支付宝开放平台应用 app_id。', placeholder: '2021000000000000', required: true },
    ...
    { key: 'alipay_public_key', label: '支付宝公钥', hint: '用于验签的支付宝公钥。', placeholder: '-----BEGIN PUBLIC KEY-----', required: true, multiline: true },
  ],
  wxpay_direct: [
    ...
    { key: 'app_id', label: '应用 ID', hint: '微信支付 appid。', placeholder: 'wx1234567890abcdef', required: true },
    { key: 'mch_id', label: '商户号', hint: '微信支付商户号。', placeholder: '1900000001', required: true },
    ...
    { key: 'merchant_certificate_serial', label: '商户证书序列号', hint: '商户 API 证书序列号。', required: true },
    { key: 'wechat_pay_public_key', label: '微信支付公钥', hint: '用于验签的微信支付公钥或平台证书公钥。', multiline: true },
    { key: 'wechat_pay_public_key_id', label: '微信支付公钥 ID', hint: '微信支付公钥 ID 或平台证书序列号。' },
  ],
  easypay_alipay: [
    ...
    { key: 'pid', label: '商户 PID', hint: '易支付商户 PID。', required: true },
  ...
  jeepay_alipay: [
    ...
    { key: 'mch_no', label: '商户号', hint: 'JeePay 商户号。', required: true },
    { key: 'app_id', label: '应用 ID', hint: 'JeePay 应用 ID。', required: true },
