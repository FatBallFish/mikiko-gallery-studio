...
assertEqual(adminTaskTypeLabel('reference_to_image'), '参考生图', 'reference_to_image label')
assertEqual(adminTaskTypeLabel('reference_generate'), '参考生图', 'legacy reference_generate label')
assertEqual(adminTaskTypeLabel('reference_image'), '参考生图', 'legacy reference_image label')
...
for (const rawValue of ['text_to_image', 'reference_to_image', 'image_edit']) {
