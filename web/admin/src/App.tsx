...
import { AuditPage, CallRecordsPage, CashierPage, ConfigPage, HealthPage, LoginPage, OverviewPage, PricingPage, ProviderModelsPage, ReadinessPage, RedeemPage, ReviewPage, RoutingPage, SecurityConfigPage, UserGroupsPage, UsersPage } from './pages/index'
  ...
  const page = useMemo(() => {
    ...
    switch (route) {
      ...
      case 'security-config':
        return <SecurityConfigPage onFeedback={feedback} />
      case 'readiness':
