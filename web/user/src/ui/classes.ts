export const userShell = {
  ...
  brand: 'mb-7 grid w-full cursor-pointer place-items-center gap-1.5 border-0 bg-transparent text-2xl text-[var(--accent)] no-underline max-[760px]:mb-0 max-[760px]:mr-2 max-[760px]:w-auto max-[760px]:min-w-16',
  ...
  iconTool: 'grid size-10 cursor-pointer place-items-center rounded-full border border-[var(--border)] bg-[var(--surface)] text-[var(--fg)] transition hover:border-[color-mix(in_oklch,var(--accent)_45%,var(--border))] hover:bg-[color-mix(in_oklch,var(--accent)_10%,transparent)] hover:text-[var(--accent)]',
  balancePill: 'inline-flex min-h-10 items-center gap-2 rounded-full border border-[color-mix(in_oklch,var(--accent)_28%,var(--border))] bg-[color-mix(in_oklch,var(--accent)_10%,var(--surface))] px-3 py-1 text-sm text-[var(--fg)] shadow-[0_0_24px_rgba(var(--accent-rgb),0.12)]',
  balanceAdd: 'grid size-6 cursor-pointer place-items-center rounded-full border border-[color-mix(in_oklch,var(--accent)_45%,var(--border))] bg-[var(--accent)] p-0 text-base font-black leading-none text-[var(--bg)]',
  ...
  avatarButton: 'inline-flex min-h-10 cursor-pointer items-center gap-2 rounded-full border border-[var(--border)] bg-[var(--surface)] px-2.5 py-1.5 text-sm text-[var(--fg)] transition hover:border-[color-mix(in_oklch,var(--accent)_42%,var(--border))] hover:bg-[color-mix(in_oklch,var(--accent)_8%,transparent)]',
