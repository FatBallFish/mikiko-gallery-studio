...
if (!source.includes("<CanvasEditorPage canvasID={routeCanvasId} onBack={() => writeHash('creative-canvas')} />")) {
  throw new Error('canvas editor back action must return to the canvas list')
}
