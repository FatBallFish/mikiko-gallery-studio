...
export const shellChromeClasses = {
  ...
  mobileNav: 'fixed inset-x-0 bottom-0 z-50 grid h-16 grid-cols-5 items-stretch border-t border-[var(--border)] bg-[color-mix(in_oklch,var(--bg)_90%,transparent)] px-1 pb-[env(safe-area-inset-bottom)] backdrop-blur-2xl md:hidden',
