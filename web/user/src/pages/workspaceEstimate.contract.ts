...
const changes: Array<[string, EstimateRequest]> = [
  ...
  ['pixel mode', { ...ratioPayload, size_mode: 'pixel', base_resolution: 'auto', aspect_ratio: '', pixel_size: '1536x1024' }],
  ['pixel size', { ...ratioPayload, size_mode: 'pixel', base_resolution: 'auto', aspect_ratio: '', pixel_size: '1024x1536' }],
