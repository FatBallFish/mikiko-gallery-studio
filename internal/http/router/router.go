...
func newMux(api *handlers.API, corsAllowedOrigins []string) http.Handler {
	...
	if api != nil {
		...
		mux.HandleFunc("/api/ops/admin/v1/storage/migrations", api.HandleAdminStorageMigrations)
		mux.HandleFunc("/api/ops/admin/v1/storage/stats", api.HandleAdminStorageStats)
