...
func (s *Service) Create(ctx context.Context, req CreateRequest) (Task, bool, error) {
	...
	task.PricingSnapshot = map[string]any{"price_version": verified.PriceVersion, "unit_points": verified.UnitPoints, "estimated_points": verified.EstimatedPoints, "max_reserved_points": verified.MaxReservedPoints}
