...
type ProviderInstanceStore interface {
	...
	CreateProviderInstance(ctx context.Context, req domaincashier.ProviderInstance) (domaincashier.ProviderInstance, error)
	UpdateProviderInstance(ctx context.Context, instanceID int64, req domaincashier.ProviderInstance) (domaincashier.ProviderInstance, error)
...
func (f *ConfigFacade) CreateProviderInstance(ctx context.Context, req domaincashier.ProviderInstance, adminID int64) (domaincashier.ProviderInstance, error) {
	if f.providerInstances != nil {
	...
	now := time.Now().UTC()
	normalized, err := NormalizeProviderInstance(req, next, now)
	if err != nil {
...
func (f *ConfigFacade) UpdateProviderInstance(ctx context.Context, instanceID int64, req domaincashier.ProviderInstance, adminID int64) (domaincashier.ProviderInstance, error) {
	if f.providerInstances != nil {
	...
	normalized, err := NormalizeProviderInstance(req, instanceID, time.Now().UTC())
	if err != nil {
		return domaincashier.ProviderInstance{}, errs.BadRequest(err.Error())
	}
