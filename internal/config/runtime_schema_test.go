...
func TestRuntimeSchemaMetadataIsCompleteAndSafe(t *testing.T) {
	...
	for _, key := range []string{
		...
		"PUBLIC_API_URL", "PIC_GALLERY_DOCS_URL", "PIC_GALLERY_DOCS_PROBE_URL", "CORS_ALLOWED_ORIGINS",
		...
		"WORKER_ROLES", "WORKER_IMAGE_CONCURRENCY", "WORKER_VIDEO_CONCURRENCY", "WORKER_MEDIA_CONCURRENCY", "WORKER_CLEANUP_CONCURRENCY",
		"MEDIA_FFMPEG_PATH", "MEDIA_FFPROBE_PATH", "MEDIA_TEMP_DIR", "MEDIA_TEMP_DISK_PAUSE_PERCENT", "MEDIA_TEMP_DISK_CRITICAL_PERCENT",
		"WORKER_METRICS_ADDR", "VIDEO_ARTIFACT_ALLOW_LOOPBACK", "VIDEO_ARTIFACT_TEST_CA_FILE",
	} {
