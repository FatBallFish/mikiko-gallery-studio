...
var (
	...
	ImageTasksTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{ImageTasksColumns[50]},
			},
			{
				Name:    "imagetask_lease_expires_at",
				Unique:  false,
				Columns: []*schema.Column{ImageTasksColumns[51]},
			},
			{
				Name:    "imagetask_error_code",
				Unique:  false,
				Columns: []*schema.Column{ImageTasksColumns[52]},
			},
			{
	...
	ModelAccountModelsColumns = []*schema.Column{
		...
		{Name: "max_reference_image_count", Type: field.TypeInt, Default: 5},
