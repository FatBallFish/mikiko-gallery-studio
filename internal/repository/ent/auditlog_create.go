...
func (_c *AuditLogCreate) SetIPAddr(v string) *AuditLogCreate {
	_c.mutation.SetIPAddr(v)
	return _c
}

// SetNillableIPAddr sets the "ip_addr" field if the given value is not nil.
func (_c *AuditLogCreate) SetNillableIPAddr(v *string) *AuditLogCreate {
	if v != nil {
		_c.SetIPAddr(*v)
	}
	return _c
...
func (_c *AuditLogCreate) check() error {
	...
	if _, ok := _c.mutation.IPAddr(); !ok {
		return &ValidationError{Name: "ip_addr", err: errors.New(`ent: missing required field "AuditLog.ip_addr"`)}
	}
