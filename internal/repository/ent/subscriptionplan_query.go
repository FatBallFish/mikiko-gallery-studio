...
func (_q *SubscriptionPlanQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *SubscriptionPlanQuery) FirstIDX(ctx context.Context) int {
...
func (_q *SubscriptionPlanQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *SubscriptionPlanQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *SubscriptionPlanQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *SubscriptionPlanQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SubscriptionPlanQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(subscriptionplan.Table, subscriptionplan.Columns, sqlgraph.NewFieldSpec(subscriptionplan.FieldID, field.TypeInt))
	_spec.From = _q.sql
