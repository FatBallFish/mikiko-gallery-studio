...
func (_q *PaymentProviderInstanceQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *PaymentProviderInstanceQuery) FirstIDX(ctx context.Context) int {
...
func (_q *PaymentProviderInstanceQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *PaymentProviderInstanceQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *PaymentProviderInstanceQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *PaymentProviderInstanceQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PaymentProviderInstanceQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(paymentproviderinstance.Table, paymentproviderinstance.Columns, sqlgraph.NewFieldSpec(paymentproviderinstance.FieldID, field.TypeInt))
	_spec.From = _q.sql
