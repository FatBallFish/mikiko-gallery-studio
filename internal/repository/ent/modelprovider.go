...
type ModelProvider struct {
	...
	// AuthConfigEncrypted holds the value of the "auth_config_encrypted" field.
...
func (*ModelProvider) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case modelprovider.FieldProviderCode, modelprovider.FieldProviderType, modelprovider.FieldAuthConfigEncrypted, modelprovider.FieldHealthStatus:
...
func (_m *ModelProvider) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case modelprovider.FieldAuthConfigEncrypted:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field auth_config_encrypted", values[i])
			} else if value.Valid {
				_m.AuthConfigEncrypted = value.String
			}
...
func (_m *ModelProvider) Value(name string) (ent.Value, error) {
...
func (_m *ModelProvider) Update() *ModelProviderUpdateOne {
	return NewModelProviderClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the ModelProvider entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *ModelProvider) Unwrap() *ModelProvider {
	_tx, ok := _m.config.driver.(*txDriver)
	if !ok {
		panic("ent: ModelProvider is not a transactional entity")
	}
...
func (_m *ModelProvider) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("auth_config_encrypted=")
	builder.WriteString(_m.AuthConfigEncrypted)
	builder.WriteString(", ")
