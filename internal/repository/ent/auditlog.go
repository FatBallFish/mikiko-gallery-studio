...
func (*AuditLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case auditlog.FieldActorType, auditlog.FieldActorID, auditlog.FieldAction, auditlog.FieldTargetType, auditlog.FieldTargetID, auditlog.FieldResult, auditlog.FieldIPAddr, auditlog.FieldUserAgent:
